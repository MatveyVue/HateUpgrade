...
<div style="display: flex; margin-top: -30px;">
    <p style="color: rgb(30, 88, 215);">16%</p>
...
<div class="staking-container">
    ...
    <p style="font-size: 28px; margin-left: 25px; margin-top: 5px;">20,000,000</p>
    <p style="font-size: 12px; margin-left: 25px; margin-top: -20px;">SCMD69</p>
<hr style="width: 90%; border: 0; height: 1px; background: #18191e;">
    <button style="background-color: #111217; border: 1px solid rgb(30, 88, 215); width: 110px; height: 40px; border-radius: 15px; float: right; margin-top: 35px; margin-right: 25px;">
    ...
    <p style="font-size: 28px; margin-left: 25px; margin-top: 5px; color: #4f9e3e;">+10,000</p>
    <p style="font-size: 12px; margin-left: 25px; margin-top: -20px;">SCMD69</p>
<hr style="width: 90%; border: 0; height: 1px; background: #18191e;">
    <p style="color: #6e6e6e; font-size: 12px; margin-right: 25px; float: right;">NEXT CLAIM IN</p>
    <p style="margin-top: 35px; float: right; margin-right: -65px; color: rgb(30, 88, 215);">12h 43m</p>
    <p style="color: #6e6e6e; font-size: 12px; margin-left: 25px; margin-top: 20px;">LOCK PROGRESS</p>
    <p style="margin-left: 25px; margin-top: -5px;">37/60 Days</p>
    <progress value="60" max="100" style="width: 85%; height: 8px; border-radius: 10px; overflow: hidden;"></progress>
    <p style="color: #6e6e6e; font-size: 12px; margin-left: 25px;">Unlocks in 23 days</p>
</div>
